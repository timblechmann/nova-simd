...
#define BITWISE_OPERATOR(op, opcode) \
    ...
    struct int_vec
    {
        ...
        explicit int_vec(vec<float> arg):
            data_(_mm256_castps_si256(arg.data_))
        {}
        ...
        friend int_vec op(int_vec const & lhs, int_vec const & rhs) \
        { \
    ...
    public:
        ...
        {
            return int_vec(_mm256_and_ps(_mm256_castsi256_ps(lhs.data_),
                                         _mm256_castsi256_ps(rhs.data_)));
        }

        friend inline int_vec andnot(int_vec const & lhs, int_vec const & rhs)
        {
            return int_vec(_mm256_andnot_ps(_mm256_castsi256_ps(lhs.data_),
                                            _mm256_castsi256_ps(rhs.data_)));
        }
        ...
        {
            vec ret(_mm256_cvtepi32_ps(data_));
            return ret;
        }
    };
