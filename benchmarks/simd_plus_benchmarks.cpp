...
void __noinline__ bench_2a(unsigned int n)
{
    ...
    do
    {
        plus_vec_simd<8>(out.begin(), in.begin(), in2.begin());
        i += 8;
        i2 += 8;
        o += 8;
    }
...
void __noinline__ bench_2b(unsigned int n)
{
    ...
    do
    {
        plus_vec_simd<16>(out.begin(), in.begin(), in2.begin());
        i += 16;
        i2 += 16;
        o += 16;
    }
...
void __noinline__ bench_2d(unsigned int n)
{
    ...
    do
    {
        plus_vec_simd<8>(out.begin(), in.begin(), 1.f);
        i += 8;
        o += 8;
    }
    while (--n);
...
void __noinline__ bench_2e(unsigned int n)
{
    ...
    do
    {
        plus_vec_simd<16>(out.begin(), in.begin(), 1.f);
        i += 16;
        o += 16;
    }
    while (--n);
